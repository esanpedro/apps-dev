...
{  
    public partial class FrmMain : Form
    {
        ...
        public void ScanSubFoldersAndFiles(string path)
        {
            ...
            foreach (FileInfo file in DirPath.GetFiles())
            {
                ...
                ListViewItem lvi = new ListViewItem(
                    new string[] { new ListViewItem() { ImageIndex = 0 } + file.Name, maxbytes.ToString() + " Bytes", path });
        ...
        private void btnUninstallProg_Click(object sender, EventArgs e)
        {
